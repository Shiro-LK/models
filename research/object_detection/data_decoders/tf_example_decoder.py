...
class TfExampleDecoder(data_decoder.DataDecoder):
  ...
  def __init__(self,
    ...
    if dct_method:
      ...
      #print( 'second loop :', slim_example_decoder.Tensor('image/channels') )
      #image = slim_example_decoder.Image(
       #   image_key='image/encoded', format_key='image/format', channels=4 )
  ...
  def decode(self, tf_example_string_tensor):
    ...
    tensor_dict[fields.InputDataFields.image].set_shape([None, None, self.keys_to_features['image/channels']])
